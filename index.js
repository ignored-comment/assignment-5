...
// the third one based on the library property. finally, the return value has to be the string 
// sorted of the property selected separeted with a semicolon. Remember you have to sort all of 
